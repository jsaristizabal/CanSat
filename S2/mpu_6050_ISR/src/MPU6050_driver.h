...
#define MPU6050_MOT_DETECT_CTRL_REG           0x1F    /// Motion detection threshold bits [7:0]
 ...
 */
typedef enum {
  MPU6050_RANGE_SLEEP = 0x01,  //set to sleep and detect movement
...
class MPU6050{
  ...
  public:
    ...
    void begin(mpu6050_accel_range_t, mpu6050_gyro_range_t);
